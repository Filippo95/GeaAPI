...
public class HumidityServiceTest {
     ...
     */
    @Test
    public void test_HumidityService_search_should_throw_exception_with_mac_string_empty() {
    ...
    @Test
    public void test_HumidityService_lasts_should_throw_exception_with_mac_string_empty() {
        HumidityService service=new HumidityService();
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            service.getLastHumidity("");
        });
        String expectedMessage = "il mac deve essere un mac valido";
        String actualMessage = exception.getMessage();
    ...
    @Test
    public void test_HumidityService_getAverage_should_throw_exception_with_home_mac_string_empty() {
        HumidityService service=new HumidityService();
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    public void test_HumidityService_getAverage_should_throw_exception_with_sensor_mac_string_empty() {
        HumidityService service=new HumidityService();
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    public void test_HumidityService_getAverage_should_throw_exception_with_timestamp_lte_string_empty() {
        HumidityService service=new HumidityService();
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    public void test_HumidityService_getAverage_should_throw_exception_with_timestamp_gte_string_empty() {
        HumidityService service=new HumidityService();
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            service.getAverage("B8:27:EB:B7:E3:4C","B8:27:EB:B7:E3:4C","2020-08-23T21:59:59.999Z","");
        });
