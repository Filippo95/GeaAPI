...
public class Temperatura {
    ...
    public Temperatura(String id, String home_mac, String sensor_mac, Timestamp timestamp,double value) {
        super();
    ...
    public String toString() {
        return "Tempeerature [id=" + id + ", home_mac=" + home_mac + ", sensor_mac=" + sensor_mac + ", value=" + value + ", timestamp=" + timestamp +"]";
    }
